...
import { handleVotting } from '../Actions/questions'
...
class QuestionPage extends Component {
    ...
    render() {
        const { isAnswered, userAnswer, allQ } = this.props
        const { authorName, avatar, optionOne, optionTwo } = this.props.questions[0]
        const viewer = allQ.includes(this.props.match.params.id)
...
function mapStateToProps({ questions, authedUser, users }, props) {
    ...
    const allQ = Object.keys(questions)
